...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--model_path", dest="model_path", action="store")         
    parser.add_argument("-f", "--config_path", dest="config_path", action="store")           
    parser.add_argument("-c", "--artist_name", dest="artist_name", action="store")          
    args = parser.parse_args()

    project_name = args.artist_name
